...
__all__ = ['vocab', 'metrics_cfg','splitter', 'cfg', 'usm1_err', 'usm2_err', 'usm3_err', 
           ...
           'usm3_loss', 'usm4_loss', 'combo_loss', 'usm_err_raw', 'combo_err_raw', 'c', 'get_image_mask', 'custom_accuracy','tools_list']

# %% 04_baseline.ipynb 2
from fastai.vision.all import *

tools_list = ['bipolar_dissector', 
              'bipolar_forceps', 
              'blank', 
              'cadiere_forceps', 
              'clip_applier', 
...
vocab=L([tools_list for i in range(4)])
...
def usm1_loss(preds,usm1_targs,usm2_targs,usm3_targs,usm4_targs,**kwargs): return LabelSmoothingCrossEntropy(reduction='mean')(preds[:,:cfg(1)], usm1_targs,**kwargs)
def usm2_loss(preds,usm1_targs,usm2_targs,usm3_targs,usm4_targs,**kwargs): return LabelSmoothingCrossEntropy(reduction='mean')(preds[:,cfg(1):cfg(2)], usm2_targs,**kwargs)
def usm3_loss(preds,usm1_targs,usm2_targs,usm3_targs,usm4_targs,**kwargs): return LabelSmoothingCrossEntropy(reduction='mean')(preds[:,cfg(2):cfg(3)], usm3_targs,**kwargs)
def usm4_loss(preds,usm1_targs,usm2_targs,usm3_targs,usm4_targs,**kwargs): return LabelSmoothingCrossEntropy(reduction='mean')(preds[:,cfg(3):cfg(4)], usm4_targs,**kwargs)
