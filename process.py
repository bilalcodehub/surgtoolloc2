# AUTOGENERATED! DO NOT EDIT! File to edit: 09_inference2.ipynb.

# %% auto 0
__all__ = ['execute_in_docker', 'VideoLoader', 'UniqueVideoValidator', 'Surgtoolloc_det']

# %% 09_inference2.ipynb 3
...
# %% 09_inference2.ipynb 5
execute_in_docker = False

# %% 09_inference2.ipynb 6
class VideoLoader():
    def load(self, *, fname):
        path = Path(fname)
        print(path)
